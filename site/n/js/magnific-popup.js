...
(function(a) {
    var b = "Close", c = "BeforeAppend", d = "MarkupParse", e = "Open", f = "Change", g = "mfp", h = "." + g, i = "mfp-ready", j = "mfp-removing", k = "mfp-prevent-close", l, m = function() {}, n = !!window.jQuery, o, p = a(window), q, r, s, t, u, v = function(a, b) {
        l.ev.on(g + a + h, b)
    }, w = function(b, c, d, e) {
        ...
        l.st.callbacks && (b = b.charAt(0).toLowerCase() + b.slice(1),
        l.st.callbacks[b] && l.st.callbacks[b].apply(l, a.isArray(c) ? c : [c]))
    }, y = function() {
        (l.st.focus ? l.content.find(l.st.focus).eq(0) : l.wrap).focus()
    }, z = function(b) {
        if (b !== u || !l.currTemplate.closeBtn)
            l.currTemplate.closeBtn = a(l.st.closeMarkup.replace("%title%", l.st.tClose)),
            u = b;
        return l.currTemplate.closeBtn
    }, A = function() {
        a.magnificPopup.instance || (l = new m,
        l.init(),
        a.magnificPopup.instance = l)
    }, B = function(b) {
        if (a(b).hasClass(k))
            return;
        ...
        if (c && d)
            return !0;
        if (!l.content || a(b).hasClass("mfp-close") || l.preloader && b === l.preloader[0])
            return !0;
    ...
    m.prototype = {
        ...
        open: function(b) {
            ...
            if (b.isObj === !1) {
                ...
                l.items = a.isArray(b.items) ? b.items : [b.items],
                l.index = b.index || 0;
            if (l.isOpen) {
                l.updateItemHTML();
                return
            ...
            l.st = a.extend(!0, {}, a.magnificPopup.defaults, b),
            ...
            setTimeout(function() {
                l.content ? (l._addClassToMFP(i),
                y()) : l.bgOverlay.addClass(i),
                r.on("focusin" + h, function(b) {
                    if (b.target !== l.wrap[0] && !a.contains(l.wrap[0], b.target))
                        return y(),
                        !1
                })
            }, 16),
        ...
        close: function() {
            if (!l.isOpen)
                return;
            l.isOpen = !1,
            l.st.removalDelay && !l.isLowIE ? (l._addClassToMFP(j),
            setTimeout(function() {
                l._close()
        ...
        updateItemHTML: function() {
            ...
            var c = b.type;
            x("BeforeChange", [l.currItem ? l.currItem.type : "", c]),
            l.currItem = b;
            if (!l.currTemplate[c]) {
    ...
    a.fn.magnificPopup = function(b) {
        ...
        if (typeof b == "string")
            if (b === "open") {
                var d, e = n ? c.data("magnificPopup") : c[0].magnificPopup, f = parseInt(arguments[1], 10) || 0;
                ...
                l.isOpen && l[b].apply(l, Array.prototype.slice.call(arguments, 1));
        else
            n ? c.data("magnificPopup", b) : c[0].magnificPopup = b,
            l.addGroup(c, b);
        return c
    }
    ;
        ...
        proto: {
            ...
            getInline: function(b, c) {
                ...
                if (b.src) {
                    var d = l.st.inline
                      , e = a(b.src);
                    return e.length ? (e[0].parentNode !== null && (E || (D = d.hiddenClass,
                    E = w(D),
                    D = "mfp-" + D),
                    F = e.after(E).detach().removeClass(D)),
                    l.updateStatus("ready")) : (l.updateStatus("error", d.tNotFound),
                    e = a("<div>")),
                    b.inlineElement = e,
                    e
                }
    ...
    a.magnificPopup.registerModule("image", {
        ...
        proto: {
            ...
            _onImageHasSize: function(a) {
                ...
                x("ImageHasSize", a),
                a.imgHidden && (l.content && l.content.removeClass("mfp-loading"),
                a.imgHidden = !1))
            },
            ...
            getImage: function(b, c) {
                var d = 0
                  , e = function() {
                    ...
                    b === l.currItem && (l._onImageHasSize(b),
                    l.updateStatus("ready")),
                    b.hasSize = !0,
                    b.loaded = !0) : (d++,
                  ...
                  , f = function() {
                    ...
                    b === l.currItem && (l._onImageHasSize(b),
                    l.updateStatus("error", g.tError.replace("%url%", b.src))),
                    b.hasSize = !0,
                    b.loaded = !0,
                    b.loadError = !0)
                }
                ...
                l.resizeImage(),
                b.hasSize ? (K && clearInterval(K),
                b.loadError ? (c.addClass("mfp-loading"),
                l.updateStatus("error", g.tError.replace("%url%", b.src))) : (c.removeClass("mfp-loading"),
                l.updateStatus("ready")),
                c) : (l.updateStatus("loading"),
                b.loading = !0,
    ...
    var M = "iframe"
      ...
      , O = function(a) {
        if (l.currTemplate[M]) {
            ...
            b.length && (a || (b[0].src = N),
            l.isIE8 && b.css("display", a ? "block" : "none"))
        }
    };
    ...
    a.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            ...
            preloadNearbyImages: function() {
                var a = l.st.gallery.preload, b = Math.min(a[0], l.items.length), c = Math.min(a[1], l.items.length), d;
                for (d = 1; d <= (l.direction ? c : b); d++)
                    l._preloadItem(l.index + d);
                for (d = 1; d <= (l.direction ? b : c); d++)
                    l._preloadItem(l.index - d)
            },
            _preloadItem: function(b) {
                b = P(b);
                if (l.items[b].preloaded)
                    return;
                var c = l.items[b];
