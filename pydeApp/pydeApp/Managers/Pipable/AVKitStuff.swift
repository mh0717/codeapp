...
//  }
func buffer(from image: UIImage) -> CVPixelBuffer? {
    var iosurfaceProperties: [CFString: Any] = [:]
    
    // 非 Mac Catalyst 环境下添加 OpenGL ES 相关属性
    #if !targetEnvironment(macCatalyst)
    iosurfaceProperties[kCVPixelBufferIOSurfaceOpenGLESFBOCompatibilityKey] = kCFBooleanTrue
    iosurfaceProperties[kCVPixelBufferIOSurfaceOpenGLESTextureCompatibilityKey] = kCFBooleanTrue
    #endif
    ...
    let attrs: [CFString: Any] = [
        ...
        kCVPixelBufferMetalCompatibilityKey: kCFBooleanTrue as Any,
        kCVPixelBufferOpenGLCompatibilityKey: kCFBooleanTrue as Any,
        kCVPixelBufferIOSurfacePropertiesKey: iosurfaceProperties as CFDictionary
    ]
